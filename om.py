...
img = cv2.imread(r"C:\Users\ARNAV\OneDrive\Desktop\om\Screenshot 2024-02-21 135935.png", cv2.IMREAD_COLOR)
...
reader_array=[easyocr.Reader(['hi', 'mr','ne'], gpu=False),easyocr.Reader(['ar', 'fa','ur'], gpu=False),easyocr.Reader(['fr','es','ga','de'], gpu=False),easyocr.Reader(['ru', 'rs_cyrillic','bg','uk','mn','be'], gpu=False)]
# print(easyocr.Reader.get_available_languages())
text_=""

def detectLanguage():
    for i in reader_array:
        try:
            text_=i.readtext(img)
